export const moduleCatalog = {
  ...
  // 섬네일 "싱글암(L)" = 좌측 배치용 모듈 = 팔걸이가 보기에 우측 (GLB 그대로)
  // 섬네일 "싱글암(R)" = 우측 배치용 모듈 = 팔걸이가 보기에 좌측 (mirror)
  armlessLeft: {
  ...
  // GLB(tray_left.glb): X- 본체 / X+ 트레이 (트레이가 우측에 있음)
  // "트레이(좌)" = 보기에 트레이가 좌측, 본체가 우측. mirror로 X 뒤집어야 함.
  trayLeftOne: {
