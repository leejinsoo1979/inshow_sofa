export const moduleCatalog = {
  armlessLeft: {
    label: "싱글암(좌)", width: 0.986, depth: 0.9, height: 0.68, seats: 1,
  ...
  armlessRight: {
    label: "싱글암(우)", width: 0.986, depth: 0.9, height: 0.68, seats: 1,
    model: "singleArmLeft1", mirror: true, arms: ["left"], openSides: ["right"],
    price: { fabric: 960000, leather: 1818000 },
    thumbnail: "/assets/thumbnails/singlearm_R_1.png"
  },
  doubleOne: {
    label: "더블암 1인", width: 1.222, depth: 0.9, height: 0.68, seats: 1,
  ...
  doubleTwo: {
    label: "더블암 2인", width: 1.957, depth: 0.9, height: 0.68, seats: 2,
  ...
  singleLeftTwo: {
    label: "싱글암2인(좌)", width: 1.722, depth: 0.9, height: 0.68, seats: 2,
